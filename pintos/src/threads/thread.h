...
bool thread_compare_function(const struct list_elem *first, const struct list_elem *second, void* aux UNUSED);
bool compare(struct thread *first, struct thread *second);
